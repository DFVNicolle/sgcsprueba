<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center space-x-4">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        ...
                        <span class="text-black font-semibold text-lg">SGCS</span>
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-3 overflow-x-auto scrollbar-hide flex-nowrap">
                    ...
                    <!-- Liberaciones -->
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('liberaciones.*')">
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Informes -->
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('informes.*')">
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span class="text-sm font-medium">{{ __('Informes') }}</span>
                        </div>
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="flex items-center ms-6">
                <!-- Notificaciones -->
                <button class="relative p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition mr-3">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('liberaciones.*')" class="text-gray-800 block px-4 py-2">
                {{ __('Liberaciones') }}
            </x-responsive-nav-link>
